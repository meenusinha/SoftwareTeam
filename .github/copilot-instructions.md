...
5. If handing over without PR: merge your branch into the task branch first (see "Merging Before Handover" above)
...
6. If handing over without PR: merge your branch into the task branch first (see "Merging Before Handover" above)
...
4. If handing over without PR: merge your branch into the task branch first (see "Merging Before Handover" above)
