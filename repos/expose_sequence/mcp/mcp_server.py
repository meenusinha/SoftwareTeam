...
log(REPO_NAME, "INFO", "Starting ExposeSequence MCP server")
config = load_config()
...
def query_repo(feature_request: str) -> str:
    """
    Query the expose_sequence repo's knowledge base for a feature request.
